...
const process_to_image = (process) => {
    ...
    nav.querySelector('.bt-capture-process').addEventListener('click', event => {
        ...
        let alert_html = `
        <div class="BoomiToolsOverlay" style="position:fixed;z-index:9999;display:grid;place-items:center;min-height:100vh;min-width:100vw;background: rgba(0,0,0,0.25);">
            <div class="alert_label_content warning_label_content" style="max-height: 600px; max-width: 600px; overflow: auto; padding: 10px; border-radius:4px; box-shadow:0 0 20px 0 rgba(0,0,0,0.25)">
                <span class="alert_icon" style="padding-top:0;vertical-align: middle;"><img style="width:24px; height:24px;" src="data:image/svg+xml;base64," alt="Warning"></span>
                <div class="alert_text">
        ...
        let overlay = document.querySelector('.BoomiToolsOverlay');
